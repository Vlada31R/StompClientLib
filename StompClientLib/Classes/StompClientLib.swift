...
public class StompClientLib: NSObject, SRWebSocketDelegate {
    ...
    public func openSocketConnection(with request: NSURLRequest, delegate: StompClientLibDelegate, connectionHeaders: [String: String]? = nil) {
    ...
    public func subscribeToDestination(destination: String, ackMode: StompAckMode) {
        ...
        let headers = [StompCommands.commandHeaderDestination: destination, StompCommands.commandHeaderAck: ack, StompCommands.commandHeaderDestinationId: "", StompCommands.commandHeaderHeartBeat: "10"]
